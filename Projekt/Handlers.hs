module Handlers(OperationType(ADD, ANY_DIGIT, ANY_NOT_DIGIT, ANY_ALPHA,
                ...
                handleOrGroupRepetition, handleNotOrGroup,
                handlePipeGroup, handleOrGroup, handleRangeGroup,
...
handleRangeGroup :: String -> (OperationType, String, String)
